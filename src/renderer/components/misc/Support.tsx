...
import { withdrawFromContract, depositToContract, getContract } from "renderer/services/PaymentServices";
...
const Support = () => {
  ...
  const handleClick = async () => {
    const account = await ethereum.request({ method: 'eth_requestAccounts', params: [] }) as string
