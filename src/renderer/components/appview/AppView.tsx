  ...
  return (
    ...
    >
      ...
      >
        ...
        <img alt="logo" src={logo} width="120px" height="120px" style={{}} />
        {/* </Button> */}
        <Typography
          variant="h4"
          style={{
...
const AppView = () => {
  return (
    <Stack height="100%" alignItems="center" margin="4rem 0 0 0">
      <Typography
        variant="h1"
        style={{ fontSize: '24px', margin: '0 0 3rem 0' }}
      >
        Installed App
      </Typography>
      <Box id="app-box" sx={{}}>
        <Grid container xs={12} justifyContent="center" alignItems="center">
          <LogoButton logo={pinkLogo} title="Pink App" installed />
          <LogoButton logo={redLogo} title="Red App" installed={false} />
          <LogoButton logo={orangeLogo} title="Orange App" installed />
